	                ...
	                <div class="box-body">
	                	<ul class="nav nav-tabs">
	                		@for($i=0;$i<count($invernadero->variables);$i++)
	                			@if($i==0)
							  		<li role="presentation" class="active"><a href="#temperatura"  data-toggle="tab">{{$invernadero->variables->get($i)->nombre}}</a></li>
							  	@else
						...
						<div id="myPillContent" class="tab-content">
						 	<div class="tab-pane fade active in" id="temperatura">
						 		<div class="row">
						 			<div class="col-md-8">
						 				<div class="chart">
						 	 ...
						 	 <div class="tab-pane fade" id="humedad">
						 	 	<div class="row">
						 	 		<div class="col-md-8">
						 	 			<div class="chart">
